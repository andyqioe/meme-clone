...
timerId3 = setTimeout(function() { 
	      ...
	      detector_output.value = "1, > 60 s"
	      detector_output.time = new Date();
		  mailer.postMessage(detector_output);
		  //sends the detector values--updates it everywhere in the interface
...
function receive_transaction( e ){
	//when a student takes an action -- that is a transaction
